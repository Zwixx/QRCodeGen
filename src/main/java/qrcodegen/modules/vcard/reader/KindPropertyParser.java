 ...
 */
public class KindPropertyParser extends PropertyParser {

	private KindProperty property;
	...
	void parse() {
		try {
			...
			try {
				KindProperty.Builder builder = new KindProperty.Builder();
				builder.fromName(getValue());
